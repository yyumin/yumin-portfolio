...
const alts = [
  "2020 powerlifting compoetition bench session",
  "weightlifting at venus",
  "traveling with my friends in california",
  "big bear mountain spartan race",
  "pic at granville street",
  "my drawing",
];
